...
if(isset($_GET['Kode'])) {
	...
	$mySql ="SELECT orderan.*, pelanggan.nama_pelanggan, kota_kirim.*
			...
			LEFT JOIN kota_kirim ON orderan.nm_kota= kota_kirim.kd_kota WHERE orderan.kd_pelanggan='$KodePelanggan' AND orderan.id_order ='$Kode'";
...
<table width="812" border="0" cellpadding="2" cellspacing="0" class="table-list">
  <tr>
    <td width="30" align="center" bgcolor="#CCCCCC"><strong>No</strong></td>
    <td width="74" bgcolor="#CCCCCC"><strong>Kode</strong></td>
    <td width="307" height="22" bgcolor="#CCCCCC"><b>Nama Barang </b></td>
    <td width="135" align="right" bgcolor="#CCCCCC"><b><b>Harga (Rp)</b></b></td>
    <td width="118" align="center" bgcolor="#CCCCCC"><b>Jumlah</b></td>
    <td width="124" align="right" bgcolor="#CCCCCC"><b>Total (Rp)</b></td>
  </tr>
  <?php 
	  // Deklarasi variabel
	  $subTotal		= 0;
