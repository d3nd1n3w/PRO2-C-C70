...
$infoQry = mysql_query($infoSql, $koneksi) or die ("Query salah".mysql_error());
      ...
      <form action="?page=pencarian" method="post">
        <div class="inner-form">
          <div class="input-field first-wrap">
            ...
            <input name="txtKeyword" type="text" id="search" type="text" placeholder="Cari" />
          </div>
          <div class="input-field second-wrap">
            <button type="button name="btnCari" class="btn-search">SEARCH</button>
          </div>
        </div>
<!--         <span class="info">ex. Game, Music, Video, Photography</span> -->
    ...
    <center><h1><?php echo strtoupper($infoData['nm_kategori']); ?></h1></center>
...
$barang2Sql = "SELECT barang.*,  kategori.nm_kategori FROM barang 
			LEFT JOIN kategori ON barang.kd_kategori=kategori.nm_kategori 
			$filterSQL 
